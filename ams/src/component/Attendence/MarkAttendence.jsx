    ...
    <div className='Header'>
       ...
       <span>Welcome {NameStr}</span>
        ...
        <div className="Mark_Attendence">
            ...
            <div className='box'>
                <h5>present</h5>
                <input  value="1" onClick={EnableSubmitB} onChange={(e)=>{setRadioButton(e.target.value)}} type="radio" name='Mark'/> 
            </div>
            

            <div className='box'>
                <h5>Absent</h5>
                <input value='0' onClick={EnableSubmitB} onChange={(e)=>{setRadioButton(e.target.value);}} type="radio" name='Mark' /> 
            </div>
